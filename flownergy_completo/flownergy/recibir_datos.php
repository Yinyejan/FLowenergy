...
$proyecto = [
    ...
    'mision' => 'Desarrollar y ofrecer una solución innovadora que integre una página web, base de datos y un componente electrónico de medición de energía, permitiendo a las microempresas monitorear, controlar y optimizar su consumo eléctrico.',

    // ── EDITA AQUÍ TU VISIÓN ─────────────────────────────────────────
    'vision' => 'Para 2030, ser reconocida como la herramienta líder en Yumbo que, a través de un componente electrónico, plataforma web y base de datos, permite a las microempresas analizar su consumo, identificar ineficiencias y recibir recomendaciones para optimizar recursos, fomentando eficiencia y sostenibilidad empresarial.​.',
